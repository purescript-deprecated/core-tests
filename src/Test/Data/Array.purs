...
assertEq :: forall a eff. (Show a, Eq a) => a -> a -> Eff (err :: Exception String, trace :: Trace | eff) {}
assertEq x y =
  if x /= y
...
main = do
  ...
  assertEq (elemIndex [1, 2, 1] 1) 0
  assertEq (elemIndex [1, 2, 1] 4) (-1)
  
  assertEq (elemLastIndex [1, 2, 1] 1) 2
  assertEq (elemLastIndex [1, 2, 1] 4) (-1)
  ...
  assertEq (null [1, 2, 3]) false
  assertEq (null nil) true
